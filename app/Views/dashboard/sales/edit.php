            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        echo form_dropdown('user', $data, $details->user_id, 'class="form-control select2 required"'); ?>
                    ...
                    <div class="form-group mb-4">
                        ...
                        echo form_dropdown('product', $data, $details->product_id, 'class="form-control select2 required"'); ?>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <?= form_input([
                            ...
                            'value' => date('d.m.Y', strtotime($details->sales_date)),
                        ]); ?>
...
<script>
    ...
    $(".datetime").daterangepicker({
        ...
        .on('cancel.daterangepicker', function(ev, picker) {
            $(this).val("<?= date('d.m.Y', strtotime($details->sales_date)); ?>");
        });
    ...
    $('#form').submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= route_to('route.sales.update', $details->id); ?>",
            ...
            success: (result) => {
                $(this).find('button[type="submit"]').html('Update Sale');
