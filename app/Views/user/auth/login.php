...
<div class="d-table-cell align-middle">
    ...
    <div class="text-center mt-4 mb-4">
        ...
        <p class="fs-6">
            Login to continue to User Dashboard
        </p>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="text-center">Dont have an account? <a href="<?= route_to('route.user.register'); ?>">Register Now</a></p>
        </div>
    </div>
</div>
...
<script>
    $('#form').submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= route_to('route.user.login.validate'); ?>",
