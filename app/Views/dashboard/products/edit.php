            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <figure class="figure">
                            <img id="current-image" src="<?= base_url('assets/img/products/' . $details->image); ?>" class="figure-img img-thumbnail rounded" style="width: 100px;">
                            <figcaption class="figure-caption text-center">Current Image</figcaption>
                        </figure>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        echo form_dropdown('category', $data, $details->category_id, 'class="form-control select2 required"'); ?>
                    ...
                    <div class="form-group mb-4">
                        ...
                        echo form_dropdown('brand', $data, $details->brand_id, 'class="form-control select2 required"'); ?>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select name="attribute[]" data-placeholder="--Select--" class="form-control select2 required" multiple>
                            ...
                            <?php if (!empty($attributes)) :
                                ...
                                $attr = explode(",", $details->attributes);
                                ...
                                foreach ($attributes as $attribute) : ?>
                                    ...
                                    <optgroup label="<?= $attribute->name; ?>">
                                        ...
                                        <?php foreach (explode(',', $attribute->values) as $value) : ?>
                                            ...
                                            <option class="ps-2" value="<?= $value; ?>" <?= (in_array($value, $attr)) ? 'selected' : ''; ?>>
                                                <?= $value; ?>
                                            </option>
...
<script>
    ...
    $('#form').submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= route_to('route.products.update', $details->id); ?>",
            ...
            success: (result) => {
                $(this).find('button[type="submit"]').html('Update Product');
