        ...
        <div class="col-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a class="btn bg-white border py-2 text-nowrap" href="<?= route_to('route.categories.new'); ?>">
                    ...
                    <table id="datatables-reponsive" class="table table-striped w-100">
                        <thead>
                            <tr>
                                ...
                                <th data-data="name">Category Name</th>
...
<script>
    $(document).ready(function() {
        ...
        const table = $("#datatables-reponsive").DataTable({
            responsive: true,
            ajax: {
                url: '<?= route_to("route.categories.fetch"); ?>',
                type: 'post',
        ...
        $(this).on('click', '.delete-btn', function() {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        url: '<?= route_to("route.categories.delete"); ?>',
                        type: 'DELETE',
                        data: {
                            ids
                        },
