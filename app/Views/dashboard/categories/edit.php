...
<script>
    $('#form').submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= route_to('route.categories.update', $details->id); ?>",
            ...
            success: (result) => {
                $(this).find('button[type="submit"]').html('Update Category');
                ...
                setTimeout(() => location.href = '<?= route_to("route.categories"); ?>', 2000);
            },
            error: (response) => {
